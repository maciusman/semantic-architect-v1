 ...
 * @param {Object} rawGraph - The raw knowledge graph to clean
 * @returns {Object} - Cleaned knowledge graph
 */
function cleanKnowledgeGraph(rawGraph) {
 ...
 * @param {Object} originalGraph - Original knowledge graph
 * @param {Object} cleanedGraph - Cleaned knowledge graph
 * @returns {Object} - Cleaning statistics
 */
function getCleaningStats(originalGraph, cleanedGraph) {
...
module.exports = { cleanKnowledgeGraph, getCleaningStats };